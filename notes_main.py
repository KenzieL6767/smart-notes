...
def save_note():
    if list_notes.selectedItems():
        ...
        print("Notes is not selcted! Select note to save!")
...
def del_note():
    if list_notes.selectedItems():
        ...
        print("Notes is not selcted! Select note to delete!")
...
def add_tag():
    if list_notes.selectedItems():
        ...
        print("Notes is not selcted! Select note to add tag!")
...
def del_tag():
    if list_notes.selectedItems():
        ...
        print("Notes is not selcted! Select tag to delete!")
